...
#
#  $ bin/test -s vk.zipexport -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src vk.zipexport.testing.VK_ZIPEXPORT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/vk/zipexport/tests/robot/test_example.robot
#
